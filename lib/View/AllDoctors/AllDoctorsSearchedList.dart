...
class AllDoctorsSearchedList extends StatelessWidget {
  String LOGD = 'AllDoctorsSearchedList';
  List<SearchDocList> _doctors;
  List<SpecialistList> _specialist;



  AllDoctorsSearchedList(this._doctors,this._specialist);
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                    width: width * 0.53,
                                    child: CustomText(size: 20,Txt: _doctors[index].name,alignText: TextAlign.start,color: ConstStyles.BlackBackGround,)),
                                //TODO Doctor Specialist
                                SizedBox(
                                  width: width * 0.53,
                                  child: _doctors[index].department != null ?CustomText(Txt: _doctors[index].department,alignText: TextAlign.start,size: 15,) : CustomText(Txt: '',alignText: TextAlign.start,size: 15,),),
                                //TODO DoctorPrice
                                SizedBox(
                                    width: width * 0.53,
                                    child: Row(
                      ...
                      Padding(
                        ...
                        child: CustomText(size: 18,Txt: '${_doctors[index].address},${_doctors[index].city},${_doctors[index].government}'),
                      ),
                    ],
                  ),
                ),
                    ...
                    children: [
                      CustomButton(text: ConstString.Details, onClick: (){
                        showDialog(
                            context: context,
                            builder: (context) {
                              print('Testtt:: ${_doctors[index].key}');
                              // return Container();
                              return CreateAppointmentDetails(null , _doctors[index]);
                            });
                      }),
                    ],
                  ),
...
/*
  String getDepartment(depId){
    print('$LOGD Length --> ${_specialist.length} ');
    if(depId != null){
