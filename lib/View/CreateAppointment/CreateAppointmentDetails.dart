...
class CreateAppointmentDetails extends StatelessWidget {
  ...
  CreateAppointmentDetails(this._appointmentData,this._docList){
    if(_docList == null){
      ...
      controller.getAvailableTime(_allDoctorsController.currentDate,_appointmentData.doctorKey);
    }else{
      print('Testtt:: ${_docList.key}');
      controller = Get.put(CreateDetailsAppointmentController(_docList.key));
      if(controller.dateSession !=null){
        controller.dateSession = null;
      }
      controller.currentDate = _allDoctorsController.currentDate;
      controller.getCurrentDate();
      controller.getAvailableTime(_allDoctorsController.currentDate,_docList.key);
    }
              ...
              child: Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    //TODO Times List
                    GetBuilder<CreateDetailsAppointmentController>(builder: (_){
                      if(controller.availableTimes != null){
                        return Container(
                          width: width,
                          height: height * 0.25,
                          decoration: BoxDecoration(
                          ...
                          child: _docList == null ? AvailableTimesList(
                              controller
                                  .availableTimes,_appointmentData.doctorKey) : AvailableTimesList(
                              controller
                                  .availableTimes,_docList.key),
                        );
                      }else{
                        return SizedBox(
                            width: width,
